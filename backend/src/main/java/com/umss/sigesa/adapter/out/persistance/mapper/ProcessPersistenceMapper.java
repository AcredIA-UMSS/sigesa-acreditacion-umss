...
public class ProcessPersistenceMapper {
    ...
    public AccreditationProcessJpaEntity toJpaEntity(AccreditationProcess domain) {
        AccreditationProcessJpaEntity processEntity = AccreditationProcessJpaEntity.builder()
                ...
                .status(domain.getStatus() != null ? domain.getStatus().name() : "ACTIVE")
                .taxonomySnapshotVersion(domain.getTaxonomySnapshotVersion())
    ...
    public AccreditationProcess toDomain(AccreditationProcessJpaEntity entity) {
        return AccreditationProcess.builder()
                ...
                .type(entity.getType() != null ? ProcessType.valueOf(entity.getType()) : null)
                .status(entity.getStatus() != null ? ProcessStatus.valueOf(entity.getStatus()) : ProcessStatus.ACTIVE)
                .taxonomySnapshotVersion(entity.getTaxonomySnapshotVersion())
