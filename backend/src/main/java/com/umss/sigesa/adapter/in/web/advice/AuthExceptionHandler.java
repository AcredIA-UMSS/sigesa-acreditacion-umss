...
public class AuthExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleInvalidProfile(InvalidUserProfileException ex) {
        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY)
                .body(Map.of("error", "INVALID_USER_PROFILE", "message", ex.getMessage()));
    }

    @ExceptionHandler(WeakPasswordException.class)
    public ResponseEntity<Map<String, String>> handleWeakPassword(WeakPasswordException ex) {
        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY)
                .body(Map.of("error", "WEAK_PASSWORD", "message", ex.getMessage()));
    }
