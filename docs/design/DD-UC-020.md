...
# Design Doc `DD-UC-020` — Evaluador externo [EE] (MOD-REVIEW)
...
- **Caso de uso**: [`FSD-UC-020`](../product/uc/FSD-UC-020.md)
- **Alcance v1.1**:
...
`PRD-US-026` → `FSD-UC-020` → `DD-UC-020` → `PR-IMPL-014` → código → DTP §A.3
