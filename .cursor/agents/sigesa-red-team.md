...
4. Catálogo operativo: **`ataques/*.json`**. CI: **`./run.sh sync`** + `RedTeamAssistantCatalogWebMvcTest`. LLM vivo: **`./run.sh probar --trials 3`**.
...
Documentación: `docs/MODELO_DE_AMENAZAS.md`, `docs/qa/redteam/AI-SEC-001.md`, catálogo `ataques/*.json`.
